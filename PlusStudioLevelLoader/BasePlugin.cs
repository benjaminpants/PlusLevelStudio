...
{
    [BepInPlugin("mtm101.rulerp.baldiplus.levelstudioloader", "Plus Level Loader", "1.12.0.0")]
    ...
    public class LevelLoaderPlugin : BaseUnityPlugin
    {
        ...
        IEnumerator LoadEnumerator()
        {
            ...
            npcAliases.Add("baldi_fast", MTM101BaldiDevAPI.npcMetadata.Get(Character.Baldi).prefabs["FastBaldi"]);
            ...
            foreach (PosterObject poster in allBasePosters)
            {
                ...
                if (poster.name == ("StoreNeon_4_wRestockBase") || (poster.name.StartsWith("Chk_Lvl")))
                {
                    continue;
                }
