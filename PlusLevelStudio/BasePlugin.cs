...
{
    [BepInPlugin("mtm101.rulerp.baldiplus.levelstudio", "Plus Level Studio", "1.8.3.1")]
    ...
    public class LevelStudioPlugin : BaseUnityPlugin
    {
        ...
        private Version expectedLoaderVersion = new Version("1.12.2.0");
        ...
        IEnumerator LoadAssets()
        {
            ...
            AddSolidColorLightmap("light_green", Color.Lerp(Color.green,Color.white,0.65f));
            AddSolidColorLightmap("light_yellow", Color.Lerp(Color.yellow, Color.white, 0.65f));
