    ...
    public static class EditorInterfaceModes
    {
        ...
        public static void AddVanillaItems(EditorMode modeToModify)
        {
            AddToolsToCategory(modeToModify, "items", new EditorTool[]
            {
                ...
                new ItemTool("stickerpack", false),
                new ItemTool("stickerpack_large", false),
                new ItemTool("stickerpack_twin", false),
                new ItemTool("stickerpack_bonus", false),
                new ItemTool("stickerpack_fresh", false),
                new ItemTool("gluestick", true),
                ...
                new ItemTool("points25", LevelStudioPlugin.Instance.uiAssetMan.Get<Sprite>("Tools/items_points25"), false),
                new ItemTool("points50", LevelStudioPlugin.Instance.uiAssetMan.Get<Sprite>("Tools/items_points50"), false),
                new ItemTool("points100", LevelStudioPlugin.Instance.uiAssetMan.Get<Sprite>("Tools/items_points100"), false),
                new ItemTool("points250", LevelStudioPlugin.Instance.uiAssetMan.Get<Sprite>("Tools/items_points250"), false),
                new ItemTool("lost_item0"),
                new ItemTool("lost_item1"),
                new ItemTool("lost_item2"),
                new ItemTool("lost_item3"),
                new ItemTool("lost_item4"),
                new ItemTool("lost_item5"),
                new ItemTool("lost_item6"),
                new ItemTool("lost_item7"),
                new ItemTool("lost_item8"),
                new ItemTool("lost_item9"),
            }, true);
        }
